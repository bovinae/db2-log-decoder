...
/* When constants are defined in a header file - let's suppress their message */
#if defined(_AIX) || defined(XLC_LINUX_SUPPORT)
   #pragma info(nouse)
#endif
...
{
   // wrapperLibName                     wrapperLibHandle   hook
   // --------------------------------   ----------------   ----
...
#ifdef CDE_SUPPORT
   {OSSE_SHARED_LIB_NAME(db2cde),        NULL,              NULL},
#endif
   {OSSE_SHARED_LIB_NAME(db2csdkt),      NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lsbiors),    NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lsblast),    NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lsentrez),   NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lsfile),     NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lshmmer),    NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lsldap),     NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lsscript),   NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2lsxml),      NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2qgjava),     NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2wbi),        NULL,              NULL},
   {OSSE_SHARED_LIB_NAME(db2ws),         NULL,              NULL}
};
