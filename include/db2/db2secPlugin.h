...
**
**  (C) COPYRIGHT International Business Machines Corp. 1991, 2018
**  All Rights Reserved
...
/**********************************************************************
** DB2SEC_API_VERSION is deprecated, use the new function set versions
***********************************************************************/
...
#define DB2SEC_USERID_PASSWORD_CLIENT_AUTH_FUNCTIONS_VERSION_1 1
#define DB2SEC_USERID_PASSWORD_CLIENT_AUTH_FUNCTIONS_VERSION DB2SEC_USERID_PASSWORD_CLIENT_AUTH_FUNCTIONS_VERSION_1

#define DB2SEC_USERID_PASSWORD_SERVER_AUTH_FUNCTIONS_VERSION_1 1
#define DB2SEC_USERID_PASSWORD_SERVER_AUTH_FUNCTIONS_VERSION DB2SEC_USERID_PASSWORD_SERVER_AUTH_FUNCTIONS_VERSION_1

#define DB2SEC_GSSAPI_CLIENT_AUTH_FUNCTIONS_VERSION_1 1
#define DB2SEC_GSSAPI_CLIENT_AUTH_FUNCTIONS_VERSION_2 2
#define DB2SEC_GSSAPI_CLIENT_AUTH_FUNCTIONS_VERSION DB2SEC_GSSAPI_CLIENT_AUTH_FUNCTIONS_VERSION_2

#define DB2SEC_GSSAPI_SERVER_AUTH_FUNCTIONS_VERSION_1 1
#define DB2SEC_GSSAPI_SERVER_AUTH_FUNCTIONS_VERSION DB2SEC_GSSAPI_SERVER_AUTH_FUNCTIONS_VERSION_1

#define DB2SEC_GROUP_FUNCTIONS_VERSION_1 1
#define DB2SEC_GROUP_FUNCTIONS_VERSION DB2SEC_GROUP_FUNCTIONS_VERSION_1
...
** supports depending on the type of server auth plugin:
**   DB2SEC_USERID_PASSWORD_SERVER_AUTH_FUNCTIONS_VERSION_*
**   DB2SEC_GSSAPI_SERVER_AUTH_FUNCTIONS_VERSION_*
** 
** client_fns
** Output. 
...
** The highest version number of the API that DB2 currently
** supports:
**   DB2SEC_GROUP_FUNCTIONS_VERSION_*
**
** group_fns
** Output. 
...
** returned during init
***********************************************************************/
typedef struct gssapi_client_auth_functions_2
{
     db2int32 version;
     db2int32 plugintype;
/**********************************************************************
...
/**********************************************************************
** db2secGenerateInitialCredAccessToken API
** Obtains the initial GSS-API credentials based on the access token
** that is passed in. The credential handle that is returned
** in pGSSCredHandle parameter is the handle that is used with the
** gss_init_sec_context API and must be either an INITIATE or BOTH 
** credential. The db2secGenerateInitialCredAccessToken API is only called
** when an access token is supplied. Otherwise, DB2
** will specify the value GSS_C_NO_CREDENTIAL when calling the
** gss_init_sec_context API to signify that the default credential
** obtained from the current login context is to be used. 
**
** db2secGenerateInitialCredAccessToken API parameters
**
** accesstoken
** Input.
** The access token used to represent the user
** 
** accesstokenlen
** Input.
** Length in bytes of the accesstoken parameter value. 
**
** accesstokenspace
** Input.
** The namespace from which the access token was obtained. 
** 
** accesstokenspacelen
** Input.
** Length in bytes of the accesstokenspace parameter value. 
**
** accesstokenspacetype
** Input.
** The type of accesstokenspace. 
**
** dbname
** Input.
** The name of the database being connected to. The API is
...
** the db2secFreeInitInfo API at the end of the authentication process,
** at which point these resources are freed. If the
** db2secGenerateInitialCredAccessToken API does not need to maintain such a list,
** then it should return NULL.
**
** errormsg
** Output.
** A pointer to the address of an ASCII error message string allocated
** by the plug-in that can be returned in this parameter if the 
** db2secGenerateInitialCredAccessToken API execution is not successful. 
** Note:
** For this API, error messages should not be created if the return
** value indicates a bad user ID or password. An error message should
** only be returned if there is an internal error in the API that
...
** of the error message string in errormsg parameter. 
***********************************************************************/
     SQL_API_RC ( SQL_API_FN *db2secGenerateInitialCredAccessToken)
...
/**********************************************************************
** db2secGenerateInitialCredApiKey API
** Obtains the initial GSS-API credentials based on the access token
** that is passed in. The credential handle that is returned
** in pGSSCredHandle parameter is the handle that is used with the
** gss_init_sec_context API and must be either an INITIATE or BOTH 
** credential. The db2secGenerateInitialCredApiKey API is only called
** when an access token is supplied. Otherwise, DB2
** will specify the value GSS_C_NO_CREDENTIAL when calling the
** gss_init_sec_context API to signify that the default credential
** obtained from the current login context is to be used. 
**
** db2secGenerateInitialCredApiKey API parameters
**
** apikey
** Input.
** The access token used to represent the user
...
** apikeylen
** Input.
** Length in bytes of the apikey parameter value. 
**
** apikeyspace
** Input.
** The namespace from which the access token was obtained. 
...
** apikeyspacelen
** Input.
** Length in bytes of the apikeyspace parameter value. 
**
** apikeyspacetype
** Input.
** The type of apikeyspace. 
**
** dbname
** Input.
** The name of the database being connected to. The API is
...
** the db2secFreeInitInfo API at the end of the authentication process,
** at which point these resources are freed. If the
** db2secGenerateInitialCredApiKey API does not need to maintain such a list,
** then it should return NULL.
**
** errormsg
** Output.
** A pointer to the address of an ASCII error message string allocated
** by the plug-in that can be returned in this parameter if the 
** db2secGenerateInitialCredApiKey API execution is not successful. 
** Note:
** For this API, error messages should not be created if the return
** value indicates a bad user ID or password. An error message should
** only be returned if there is an internal error in the API that
...
** of the error message string in errormsg parameter. 
***********************************************************************/
     SQL_API_RC ( SQL_API_FN *db2secGenerateInitialCredApiKey)
                           ( const char     *apikey,
                             db2int32        apikeylen,
...
} db2secGssapiClientAuthFunctions_2;
