...
#define SQLQG_TRUST_MPP_MQT_DISABLE_COMMIT  0x0080 // Blocking commit for mpp system maintained mqt under trust mode
...
public:
  ...
  bool      is_parallelism_enabled(void);
...
protected:
  ...
  */
  ...
  sqluint8  m_parallelism_option;             //PARALLELISM (Y|N)
